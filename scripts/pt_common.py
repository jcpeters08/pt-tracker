...
EXERCISE_ALIASES: dict[str, str] = {
    ...
    "seated db front raise":                 "db-front-raise",
    "seated dumbbell front raise":           "db-front-raise",
    ...
    "high-bar squat":                        "barbell-back-squat",
    "low-bar squat":                         "barbell-back-squat",
    "db rdl":                                "db-rdl",
